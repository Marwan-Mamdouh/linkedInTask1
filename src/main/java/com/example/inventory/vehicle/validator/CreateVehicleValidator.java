 ...
 *
 * <p>
 * Checks business logic: - Does dealer exist in this tenant? - Is price
 * reasonable (business
...
public class CreateVehicleValidator {
   ...
   *
   * <p>
   * This is CRITICAL for multi-tenancy: - Prevents vehicles from being assigned
   * to dealers in
   * other tenants - If you skip this, user A could assign a vehicle to user B's
   * dealer!
   */
   ...
   *
   * <p>
   * Business rule: Vehicle price must be between $0.01 and $10,000,000 (already
   * checked
